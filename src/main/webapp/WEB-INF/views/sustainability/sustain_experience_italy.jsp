...
<article class="v_articlePage v_articleId6"><header class="v_section v_hero"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/6/hero_L.jpg&quot;);"><div tabindex="-1" aria-hidden="true" class="v_backgroundVideo"><div></div></div></div> <div class="v_sectionRestrict"><div class="v_sectionContent"><h1>이탈리아에서 커피 주문하는 방법: <br>규칙</h1> <!----> <!----></div></div> <div class="v_video"><div id=""></div> <button class="v_btnRoundM v_btnClose"><i aria-hidden="true" class="fn_close"></i> <span>닫기</span></button></div> <button class="v_btnRoundM v_btnScrollTo"><i aria-hidden="true" class="fn_angleDownCircle"></i> <span class="v_visually_hidden">카테고리로 이동</span></button> <div class="v_articlesAnchor"></div></header> <div class="v_article"><p class="v_headline">블랙 커피의 고향으로 떠나보시겠습니까?<br>이탈리아 사람처럼 커피를 주문하는 방법이 있습니다.</p><p class="v_paragraph">이탈리아 사람들은 커피를 마시는 것을 예술의 경지로 승화시킵니다. 커피 시럽이 있는 평범한 커피샵에서 몇 시간 동안 어슬렁거리거나 출근 길에 캔 커피를 들고 가지 않습니다. 그 보다는, 바에 들어가 카운터에 서서 '커피 한잔'을 마십니다. 이탈리아에서는 법으로 좌석마다 세금이 부과되기 때문에 바에 서서 커피를 마시는 오랜 전통이 이어져 오고 있습니다.</p><blockquote class="v_emphasis">커피를 주문하는 것이 쉬워 보일 수도 있지만 <br>이탈리아에서는 몇 가지 알고 있어야 할 내용이 있습니다. </blockquote><p class="v_paragraph">커피 주문을 위해서는 여느 고급 문화처럼 익혀 두어야 할 몇 가지 사항이 있습니다. 만약 여러분이 블랙 커피의 본고장이라고 할 수 있는 이탈리아에서 당황하지 않길 원한다면 '이탈리아에서 커피 주문하기' 가이드를 읽어 보세요. </p>
<div class="v_section v_listicle_item"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/6/listicle_barman_L.jpg&quot;);"></div> <figure><figcaption><div class="v_table"><div class="v_cell"><span>01</span></div> <div class="v_cell"><h3>예전에 와 본 것처럼 주문하기</h3> <p>이탈리아의 바는 질서 정연하게 줄을 서서 바리스타에게 커피를 주문하는 그런 곳이 아닙니다. 직접 카운터로 가서 주문을 해야 합니다. </p></div></div></figcaption></figure></div>
<div class="v_section v_listicle_item"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/6/listicle_pay_L.jpg&quot;);"></div> <figure><figcaption><div class="v_table"><div class="v_cell"><span>02</span></div> <div class="v_cell"><h3>이탈리아 사람처럼 계산하기</h3> <p>계산을 하기에 앞서, 이탈리아 바의 경우 계산 방법이 다양하기 때문에 먼저 어떻게 계산할 것인지를 결정해야 합니다. 보통 주문을 하고 계산기에서 지급한 다음 영수증을 바리스타에게 가져다 줍니다. 그러나 어떤 지역에서는, 바에서 주문을 하고 커피를 마신 다음 계산대에 있는 직원에게 자신이 마신 커피를 알려줍니다. 지금 귀하께서 계신 지역에서는 어떤 방식을 사용하는지 잠시 확인해 보세요. </p></div></div></figcaption></figure></div>
<div class="v_section v_listicle_item"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/6/listicle_milk_L.jpg&quot;);"></div> <figure><figcaption><div class="v_table"><div class="v_cell"><span>03</span></div> <div class="v_cell"><h3>전통적인 블랙커피의 고장</h3> <p>아침이 아니라면 라떼나 카푸치노는 주문하지 마세요. 낮 시간에는 전통적인 블랙커피를 주문하세요. </p></div></div></figcaption></figure></div>
<div class="v_section v_listicle_item"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/6/listicle_espresso_L.jpg&quot;);"></div> <figure><figcaption><div class="v_table"><div class="v_cell"><span>04</span></div> <div class="v_cell"><h3>에스프레소라고 말하지 마세요</h3> <p><a href="”{ARTICLE_ID=1}”"> 이탈리아에서 커피는 에스프레소를 의미하기 때문에 주문할 때 굳이 얘기하지 않으셔도 됩니다. 이탈리아어로 정확한 용어는 'un caffè'입니다. 멋지고 단순한 표현이죠.        </a></p></div></div></figcaption></figure></div>
<div class="v_section v_listicle_item"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/6/listicle_cool_down_L.jpg&quot;);"></div> <figure><figcaption><div class="v_table"><div class="v_cell"><span>05</span></div> <div class="v_cell"><h3>전형적인 관광객용 커피 메뉴는 피하세요.</h3> <p>만약 전문가(지역의 커피전문가)와 함께 시간을 보내시길 원하신다면, 지금 유행하고 있는 커피 대신 전통적인 커피를 선택해 보세요. 나폴리의 un caffè alla nocciola(헤이즐넛 에스프레소)같이 지역 별로 유명한 커피를 굳이 찾는 것이 아니라면 Cappuccino con tanta schiuma, Con poca schiuma, Cappuccino tiepido, Cappuccino ben caldo, chiaro, scuro 같은 커피 중에 한 가지를 마셔 보세요. 그 외에도 un caffè in tazza grande, macchiato freddo, macchiato caldo, macchiato chiaro 및 macchiato scuro 같은 커피도 있습니다. 그것도 아니고 무언가 신선한 것을 원한다면 (브랜디나 그라파 원샷이 추가된 에스프레소인) un caffè corretto를 주문해 보세요. </p></div></div></figcaption></figure></div>
<div class="v_section v_listicle_item"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/6/listicle_break_L.jpg&quot;);"></div> <figure><figcaption><div class="v_table"><div class="v_cell"><span>06</span></div> <div class="v_cell"><h3>데지 않게 조심하기.</h3> <p>커피를 마시기 전에 잠깐 시간을 가지세요. 커피 자체가 뜨거울 수도 있고 이탈리아 바리스타들의 특성상 컵을 데울 수도 있으니까요.</p></div></div></figcaption></figure></div>
<div class="v_section v_listicle_item"><div class="v_bg v_bg_loaded" style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/coffeeCommunicationPlatform/coffeeCommunicationPlatform/img/6/listicle_drink_L.jpg&quot;);"></div> <figure><figcaption><div class="v_table"><div class="v_cell"><span>07</span></div> <div class="v_cell"><h3>이탈리아 사람처럼 커피 마시기.</h3> <p>이탈리아에서는, 하루에 몇 차례씩 작은 잔의 에스프레소 커피를 마시는 것이 일반적입니다. 이런 이탈리아의 전통을 따르려면, 하루에 몇 차례 휴식을 취할 수 있는 준비가 되어 있어야 하겠죠. </p></div></div></figcaption></figure></div>
...
<li><a href="/nespresso/sustainability/the-coffee-experience/grinding" class="">커피 그라인딩이 과학인 이유 <i class="fas fa-angle-right" style="font-size:1em;line-height:0;position:relative;top:1px"></i></a></li></ul>
</aside> 
