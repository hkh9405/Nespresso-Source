	    ...
	    $("html").click(function(event) {
	      if (event.target.id === "myModal4") {
			...
			<div id="contents">
				<app>
				<div class="wrapper">
					<input type="button" value="등록하기" onclick="location.href='http://localhost:8080/nespresso/noticecreated.action';"
						style="right: 21%; position: absolute;"/><br/><br/>
					<article>
					...
					<div class="titleSection">
						...
						<h3>${dto.nsubject } &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="${articleUrl }&nnum=${dto.nnum}" style="right: -10%;">수정하기</a></h3>
						</div>
