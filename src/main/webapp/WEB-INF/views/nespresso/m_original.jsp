...
<link rel="stylesheet" type="text/css" href="/nespresso/resources/css/OriginalSystem.css" />
...
<!-- ------------------------------------------상단 끝---------------------------------------------------- -->
	...
	<div id="block-8810057553397" class="free-html" data-label="">
		<div class="g g_originalLine g_originalSytem">
				...
				<div class="g_restrict">
					<div class="g_fil">
						<ol>
							...
							<li><a href="./original-classic-espresso-experience"
								class=""><span class="">오리지널 시스템</span></a></li>
						</ol>
					</div>
					<div class="g_mobileMenu">
						<button class="g_btnMenu g_txt_S">
							<span class="">오리지널 시스템</span><i aria-hidden="true"
								class="fn_angleDown"></i>
						</button>
					...
					<div class="g_menu">
						<ul>
							<li><a href="./choose-your-system" class="g_btn"><span
									class="">선택하기</span></a></li>
			...
			<section id="hero" data-label=""
				class="g_section g_hero g_light g_center g_mobileBottom"
				classnames="g_center g_hero g_light">
			<div class="g_bg g_imgSrc g_imgSrc_loaded"
				style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/define/originalSystem/img/backgrounds/ol_hero_machine_L.jpg&quot;);"></div>
			<div class="g_restrict">
				<div class="g_content">
					<div class="g_text">
						<!---->
						<h1 class="g_h1">
							오리지널<br>클래식한 에스프레소 고압 추출
						</h1>
						<button class="g_playVideo" onclick="window.open('https://youtu.be/Zosl99ssJdM')">
							<span class="g_headline">비디오 보기</span>
							<i class="fas fa-play-circle"></i>
							<!-- <i aria-hidden="true" class="fn_videoCircle"></i> -->
						</button>
						<div class="g_anchors">
							<ul class="g_row">
								<li><button class="g_anchor">
										<svg xmlns="http://www.w3.org/2000/svg" width="80px"
											height="80px" viewBox="0 0 80 80"
											class="injected-svg g_visual"
											data-src="/shared_res/agility/define/img/features/ol_icon_2.svg"
											aria-hidden="true"> <path
											d="M40 0C17.9 0 0 17.9 0 40s17.9 40 40 40 40-17.9 40-40S62.1 0 40 0zm0 78.5C18.7 78.5 1.5 61.3 1.5 40S18.7 1.5 40 1.5 78.5 18.7 78.5 40 61.3 78.5 40 78.5z"></path>
										<path
											d="M56 29.7c1.4.5 2.3 1.6 2.7 3.4.3 1.1.3 2.2.3 3.2h-2.8c-.4 0-.7.3-.7.7s.3.7.7.7h3.4c.4 0 .6-.3.7-.6v-.4c.1-1.2 0-2.6-.3-4-.5-2.2-1.7-3.7-3.7-4.4-.4-.1-.8.1-.9.5 0 .4.3.8.6.9z"></path>
										<path
											d="M60.3 47.9h-5.9V25.4c0-.4-.3-.7-.7-.7H29.9c-.4 0-.7.3-.7.7v2.8h-8.7c-.4 0-.7.3-.7.7V56c0 .4.3.7.7.7h35.7c.3 0 .5-.1.6-.4l4-7.5c.4-.4 0-.9-.5-.9zM29 29.6v25.7h-7.8V29.6H29zm26.8 25.7H30.5V29.5v-.2c.1-.1.1-.3.1-.4v-2.8H53v22.5c0 .4.3.7.7.7h5.4l-3.3 6z"></path>
										</svg>
										<span class="">오리지널 테크놀로지</span>
									</button>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<button class="g_anchor">
										<svg xmlns="http://www.w3.org/2000/svg" width="80px"
											height="80px" viewBox="0 0 80 80"
											class="injected-svg g_visual"
											data-src="/shared_res/agility/define/img/features/ol_icon_1.svg"
											aria-hidden="true"> <path
											d="M40 0C17.9 0 0 17.9 0 40s17.9 40 40 40 40-17.9 40-40S62.1 0 40 0zm0 78.5C18.7 78.5 1.5 61.3 1.5 40S18.7 1.5 40 1.5 78.5 18.7 78.5 40 61.3 78.5 40 78.5zm17.6-26h-2.4s-.1-.1-.1-.2c-.2-.4-.4-.9-.5-1.4 0-.2-.1-.9-.5-3.3-.5-3.3-1.1-8.3-1.6-11.8-.3-2.2-.5-3.8-.6-4.2 0-.3-.1-.5-.2-.8-.1-.4-.3-.7-.6-.9-.2-.2-.4-.3-.6-.4l-.2-.1c-.2-.2-1.3-.8-2.3-1.4l-2.5-1.4-.6-.3c-.4-.2-.8-.3-1.2-.3h-7.1c-.4 0-.8.1-1.2.3l-.6.3-2.4 1.4c-1.1.6-2.2 1.2-2.5 1.5l-.2.1c-.3.2-.6.3-.8.6-.2.2-.3.4-.4.6s-.1.5-.2.8L27 41.2c-.3 2.3-.6 4.6-.9 6.3-.2 1.8-.4 3.1-.5 3.3-.1.5-.3 1-.5 1.4 0 .1-.1.1-.1.2h-2.4c-.4 0-.8.3-.8.8 0 .4.3.8.8.8h35c.4 0 .8-.3.8-.8 0-.4-.4-.7-.8-.7zm-30.7 0c0-.1 0-.1.1-.2.1-.4.3-.8.3-1.1.1-.3.2-1.6.5-3.4.5-3.8 1.3-9.9 1.8-13.4l.4-2.9v-.1c0-.1.1-.1.1-.2.1-.1.3-.2.5-.3.4-.2 1.4-.8 2.5-1.4l2.5-1.4c.1-.1.3-.2.4-.2.2-.1.3-.1.5-.1h7.1c.1 0 .3 0 .5.1.1.1.3.2.4.2l2.5 1.4c1.1.6 2.1 1.2 2.5 1.4.3.2.5.3.6.4 0 0 0 .1.1.1v.1l.1.6c.2 1.1.7 5.2 1.3 9.3.3 2.3.6 4.6.9 6.3.2 1.8.4 3.1.5 3.4.1.4.2.7.3 1.1 0 .1 0 .1.1.2l-26.5.1z"></path>
										</svg>
										<span class="">오리지널 커피</span>
									</button>
								</li>
								<!-- <li><button class="g_anchor">
										<svg xmlns="http://www.w3.org/2000/svg" width="80px"
						...
						<div role="dialog" class="g_popin g_popinVideo">
			...
			<section id="choice" data-label=""
				class="g_section g_dark g_left g_mobileBottom">
			<div class="g_bg g_imgSrc g_imgSrc_loaded"
				style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/define/originalSystem/img/backgrounds/ol_machine_front_black_left_L.jpg&quot;);"></div>
			<div class="g_restrict">
				<div class="g_content">
					<div class="g_text">
						<h2 class="g_h2">당신의 취향에 맞는 커피</h2>
						<h3 class="g_h3">다양한 커피 레시피</h3>
						<div class="g_wysiwyg g_txt_M">
							<p>네스프레소의 모든 커피는 밀크와 환상적인 조화를 이룹니다. 아주 섬세하고 미묘한 풍미의 커피도 밀크,
								밀크폼 또는 크림과 만나 새로운 차원의 커피로 탄생 합니다</p>
							<p>
								커피 종류에 따라 다양한 풍미의 카푸치노와 라테 또는 마키아토를 즐기실 수 있습니다.
								<style>
#choice .g_bg {
	transform: scaleX(-1) !important;
						...
						<a href="./discover-original-coffee-machines "
							class="g_link g_iconRight"><span class="">오리지널 머신 더
								자세히 보기 ></span><!-- <i aria-hidden="true" class="fn_angleLink"></i> --></a>
					</div>
				</div>
			</div>
			</section>
			<section id="crema" data-label=""
				class="g_section g_dark g_right g_mobileBottom">
			<div class="g_bg g_imgSrc g_imgSrc_loaded"
				style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/define/originalSystem/img/backgrounds/ol_coffee_drop_L.jpg&quot;);"></div>
			<div class="g_restrict">
				<div class="g_content">
					<div class="g_text">
						<h2 class="g_h2">다양한 맛과 아로마의 커피</h2>
						<h3 class="g_h3">특별한 커피 경험</h3>
						<div class="g_wysiwyg g_txt_M">
							<p>네스프레소 커피는 다양한 맛과 고유의 개성있는 아로마를 가지고 있어 특별한 커피 경험을 선사합니다.</p>
							<p>커피 모두 특별한 개성이 있다는 것을 알고 계셨나요? 진정한 나만의 커피를 찾아보세요.</p>
						</div>
						<a href="./original-coffee-capsules" class="g_link g_iconRight"><span
							class="">오리지널 커피 더 자세히 보기 ></span>
							<!-- <i aria-hidden="true" class="fn_angleLink"></i> --></a>
					</div>
				</div>
			</div>
			</section>
			<section id="video" data-label="" class="g_section g_dark g_center">
			<div class="g_bg g_imgSrc g_imgSrc_loaded"
				style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/define/originalSystem/img/backgrounds/ol_capsules_ground_L.jpg&quot;);"></div>
			<div class="g_restrict">
				<div class="g_content">
					<div class="g_text">
						<!---->
						<div class="g_wysiwyg g_txt_XL">
							<p>
								나만의 취향에 맞는 맛과 아로마의 커피를 찾아보세요.<br>에스프레소와 룽고, 다양한 강도의 커피와 그리고
								디카페인 커피 등 오리지널 커피는 바로 클래식한 에스프레소 커피 경험 그 자체입니다.
							</p>
						</div>
						<button class="g_playVideo" onclick="window.open('https://youtu.be/Zosl99ssJdM')">
							<span class="g_headline">비디오 보기</span>
			...
			<section id="oneTouch" data-label=""
				class="g_section g_dark g_right g_mobileBottom" c="">
			<div class="g_bg g_imgSrc g_imgSrc_loaded"
				style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/define/originalSystem/img/backgrounds/ol_cups_capsules_L.jpg&quot;);"></div>
			<div class="g_restrict">
				<div class="g_content">
					<div class="g_text">
						<h2 class="g_h2">다양한 29가지 커피</h2>
						<h3 class="g_h3">29가지 커피</h3>
						<div class="g_wysiwyg g_txt_M">
							<p>전세계 커피 생산 지역에서 네스프레소의 지속가능한 방식으로 공급되어 특별한 맛과 아로마를 가진 29가지
								커피를 경험해보세요.</p>
							<p>작은 컵의 리스트레토와 에스프레소부터 룽고, 아메리카노, 밀크 레시피까지 각 개성과 강도에 따라 다양한
								커피를 선택해 즐겨보세요.</p>
							<style>
#oneTouch .g_bg {
	transform: scaleX(-1) !important;
						...
						<a href="./original-coffee-capsules" class="g_link"><span
							class="">오리지널 커피 더 자세히 보기 ></span>
							<!-- <i aria-hidden="true" class="fn_angleLink"></i> --></a>
					</div>
				</div>
			...
			<section id="taste" data-label=""
				class="g_section g_light g_left g_mobileBottom">
			<div class="g_bg g_imgSrc g_imgSrc_loaded"
				style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/define/originalSystem/img/backgrounds/ol_recipe_capsule_L.jpg&quot;);"></div>
			<div class="g_restrict">
				<div class="g_content">
					<div class="g_text">
						<h2 class="g_h2">당신의 취향에 맞는 커피</h2>
						...
						<div class="g_wysiwyg g_txt_M">
							<p>네스프레소의 모든 커피는 밀크와 환상적인 조화를 이룹니다. 아주 섬세하고 미묘한 풍미의 커피도 밀크,
								밀크폼 또는 크림과 만나 새로운 차원의 커피로 탄생 합니다</p>
							<p>커피 종류에 따라 다양한 풍미의 카푸치노와 라테 또는 마키아토를 즐기실 수 있습니다.</p>
						</div>
					</div>
				</div>
			</div>
			</section>
			<section id="faq" data-label=""
				class="g_section g_sectionFaq g_dark g_right g_mobileBottom">
			<div class="g_bg g_imgSrc g_imgSrc_error"></div>
			<div class="g_restrict">
				<div class="g_content">
					<div class="g_text">
						<h2 class="g_h2">자주 묻는 질문 (FAQ)</h2>
							...
							<ul role="accordion" class="g_isCollapsable">
								<li class="g_accordionItem">
									<button style="margin: 0 0 .25em"
										...
										class="g_title">
										<span class="g_visually_hidden">Accordion item 1 of 9</span> 
										<!-- <i aria-hidden="true" class="fn_angleUpCircle"></i>  -->
										<i class="far fa-plus-square" style="font-size: 10px; position: absolute; top: 4px; left: 10px;"
										aria-hidden="true"></i>
										<span>버츄오와 오리지널에는 어떤 차이가 있나요?</span>
									</button>
									<div class="g_wysiwyg" style="display: none;">
										<p>추출 방식이 다릅니다. 오리지널은 클래식한 고압 추출 방식으로 추출한 에스프레소에 물을 추가하여
											마일드한 아메리카노를 즐길 수 있으며, 버츄오는 새로운 센트리퓨전(Centrifusion™) 회전 추출로
											풍부한 크레마와 깊은 바디감의 커피를 큰 컵으로 즐길 수 있습니다.</p>
									</div></li>
								<li class="g_accordionItem">
									<button style="margin: 0 0 .25em"
										data-translate="Accordion item" data-of="of" tabindex="0"
										class="g_title">
										<span class="g_visually_hidden">Accordion item 2 of 9</span> 
										<!-- <i aria-hidden="true" class="fn_angleUpCircle"></i>  -->
										<i class="far fa-plus-square" style="font-size: 10px; position: absolute; top: 4px; left: 10px;"
										aria-hidden="true"></i>
										<span>캡슐을
									...
									<div class="g_wysiwyg" style="display: none;">
										<p>
											네 가능합니다. 네스프레소 캡슐은 성분이 변하지 않으면서 재사용할 수 있는 알루미늄으로 만들어졌으며, 커피
											가루는 농업용 천연 비료 또는 전기나 난방을 위한 에너지원 등으로 재사용될 수 있습니다.<br> 캡슐
											재활용의 보다 많은 참여를 위해 네스프레소는 캡슐 재활용 백을 무료로 제공해 드립니다. 재활용 백에 사용한
											캡슐을 담아 자주 방문하는 네스프레소 부티크에 가져다주시거나 가까운 전국 네스프레소 매장으로 가져다주셔도
											됩니다. 네스프레소 클럽/온라인 주문 시 재활용백 수거를 요청하시면 고객님의 제품 배송 시 함께 수거합니다.
											네스프레소 커피를 즐기시고 캡슐 재활용에 동참해주세요.
										</p>
									</div></li>
								<li class="g_accordionItem">
									<button style="margin: 0 0 .25em"
										data-translate="Accordion item" data-of="of" tabindex="0"
										class="g_title">
										<span class="g_visually_hidden">Accordion item 3 of 9</span> 
										<!-- <i aria-hidden="true" class="fn_angleUpCircle"></i> --> 
										<i class="far fa-plus-square" style="font-size: 10px; position: absolute; top: 4px; left: 10px;"
										aria-hidden="true"></i>
										<span>캡슐
									...
									<div class="g_wysiwyg" style="display: none;">
										<p>각각의 캡슐에는 전세계 커피 재배지에서 엄선한 좋은 품질의 커피가 들어 있습니다. 네스프레소는
											최상의 품질의 원두를 선택하고 선별하는 것으로 커피 제조를 시작합니다. 네스프레소의 이러한 품질 관리는 커피
											농부와의 협력 덕분에 가능합니다. 네스프레소는 진귀한 원두를 재배하기 위해 7만 명의 농부들과 협력합니다.
											다양한 커피 중 내게 맞는 커피를 골라보세요. 고유의 개성과 아로마를 가진 커피의 다양한 세계를 경험해보세요.</p>
									</div></li>
								<li class="g_accordionItem">
									<button style="margin: 0 0 .25em"
										data-translate="Accordion item" data-of="of" tabindex="0"
										class="g_title">
										<span class="g_visually_hidden">Accordion item 4 of 9</span> 
										<!-- <i aria-hidden="true" class="fn_angleUpCircle"></i> -->
										<i class="far fa-plus-square" style="font-size: 10px; position: absolute; top: 4px; left: 10px;"
										aria-hidden="true"></i>
										<span>왜
											완벽한 커피는 우연으로 만들어질 수 없는 것인가요?</span>
									</button>
									<div class="g_wysiwyg" style="display: none;">
										<p>고객이 매번 최상의 품질의 커피를 즐기는 것은 그 무엇보다 중요합니다. 커피 체리에서 한 잔의
											커피에 이르기까지 커피의 품질과 지속가능성을 지키는 것은 네스프레소의 핵심입니다. 네스프레소는 최상의 품질의
											커피를 제공할 것을 약속합니다. 네스프레소는 공정한 방식으로 완벽한 커피를 제공하기 위해 2003년부터
											열대우림연맹(Rainforest Alliance)와 AAA 지속가능한 품질 프로그램(AAA
											Sustainable Quality Program)을 운영해 왔습니다.</p>
									</div></li>
								<li class="g_accordionItem">
									<button style="margin: 0 0 .25em"
										data-translate="Accordion item" data-of="of" tabindex="0"
										class="g_title">
										<span class="g_visually_hidden">Accordion item 5 of 9</span> 
										<!-- <i aria-hidden="true" class="fn_angleUpCircle"></i> --> 
										<i class="far fa-plus-square" style="font-size: 10px; position: absolute; top: 4px; left: 10px;"
										aria-hidden="true"></i>
										<span>어떤
											맛의 네스프레소 커피를 구매할 수 있나요?</span>
									</button>
									<div class="g_wysiwyg" style="display: none;">
										<p>각각의 네스프레소 커피는 다양한 맛과 아로마를 가지고 있습니다. 강한 맛, 부드러운 맛, 산뜻한
											맛, 크리미한 맛 등 선택의 폭이 넓어 고객의 취향에 맞게 선택할 수 있습니다.</p>
									</div></li>
								<li class="g_accordionItem">
									<button style="margin: 0 0 .25em"
										data-translate="Accordion item" data-of="of" tabindex="0"
										class="g_title">
										<span class="g_visually_hidden">Accordion item 6 of 9</span> 
										<!-- <i aria-hidden="true" class="fn_angleUpCircle"></i> -->
										<i class="far fa-plus-square" style="font-size: 10px; position: absolute; top: 4px; left: 10px;"
										aria-hidden="true"></i>
										<span>네스프레소
											커피의 카페인 함량은 얼마나 되나요?</span>
									</button>
									<div class="g_wysiwyg" style="display: none;">
										<p>네스프레소 커피마다 카페인 함량이 다르지만 일반적으로 오리지널 커피는 50-120mg의 카페인을
											함유하며 버츄오는 종류에 따라 60-200mg의 카페인을 함유하고 있습니다. 각 커피 고유의 함량은 네스프레소
											클럽을 통해 문의해주시기 바랍니다.</p>
									</div></li>
								<li class="g_accordionItem"><button
										data-translate="Accordion item" data-of="of" tabindex="0"
										class="g_title">
										<span class="g_visually_hidden">Accordion item 7 of 9</span> 
										<!-- <i aria-hidden="true" class="fn_angleUpCircle"></i> -->
										<i class="far fa-plus-square" style="font-size: 10px; position: absolute; top: 4px; left: 10px;"
										aria-hidden="true"></i>
										<span>모든
											네스프레소 커피가 우유와 잘 어울리나요?</span>
									</button>
									<div class="g_wysiwyg" style="display: none;">
										<p>네 네스프레소 커피는 우유와 환상적인 조화를 이룹니다. 물론 어떤 커피를 원하느냐에 따라 조금씩
											달라질 수 있습니다. 예를 들어, 카자르와 다르칸의 강도 높은 커피의 경우에는 우유를 넣었을 때 진한 로스팅
											특성이 유지되지만, 볼루토처럼 마일드한 커피는 우유의 영향을 더 많이 받게 됩니다. 강렬한 커피는 레시피에
											우유를 더해도 기분 좋은 스모키한 쓴 맛과 로스팅향을 유지하는 반면에 마일드한 커피는 우유와 함께 마시면
											캐러멜/비스킷향이 더욱 살아납니다. 달콤한 커피 경험을 위해 여러 가지 레시피를 만들어 경험하다 보면 내가
											원하는 나만의 커피를 찾아낼 수 있을 것입니다.</p>
									</div></li>
								<li class="g_accordionItem">
									<button style="margin: 0 0 .25em"
										data-translate="Accordion item" data-of="of" tabindex="0"
										class="g_title">
										<span class="g_visually_hidden">Accordion item 8 of 9</span> 
										<!-- <i aria-hidden="true" class="fn_angleUpCircle"></i> --> 
										<i class="far fa-plus-square" style="font-size: 10px; position: absolute; top: 4px; left: 10px;"
										aria-hidden="true"></i>
										<span>커피
											원두와 커피 체리는 어떻게 다른가요?</span>
									</button>
									<div class="g_wysiwyg" style="display: none;">
										<p>커피 체리는 커피 나무의 열매를 말합니다. 커피 원두는 커피 체리의 안에 들어 있으며 로스팅 및
											그라인딩을 통해 커피로 만들어지게 됩니다.</p>
									</div></li>
								<li class="g_accordionItem">
									<button style="margin: 0 0 .25em"
										data-translate="Accordion item" data-of="of" tabindex="0"
										class="g_title">
										<span class="g_visually_hidden">Accordion item 9 of 9</span> 
										<!-- <i aria-hidden="true" class="fn_angleUpCircle"></i> --> 
										<i class="far fa-plus-square" style="font-size: 10px; position: absolute; top: 4px; left: 10px;"
										aria-hidden="true"></i>
										<span>이상적인
											커피를 만드는 방법은 무엇인가요?</span>
									</button>
									<div class="g_wysiwyg" style="display: none;">
										<p>커피는 다양한 방법으로 만들고 마실 수 있는 폭 넓은 활용도를 가지고 있습니다. 네스프레소는 언제나
											완벽한 커피 경험을 선사하는 머신과 커피를 제안합니다. 선택하는 블렌드에 따라 에스프레소와 같은 매우 강렬한
											이탈리안 커피, 더 양이 많고 부드러운 커피, 초콜릿 맛이 나는 커피 등 다양한 커피를 폭넓게 선택하며 즐길
											수 있습니다.</p>
									</div></li>
							</ul>
							<!---->
...
$( document ).ready( function() {
    $( 'button.g_title' ).click( function() {
       $(this).next().slideToggle();
			...
			<!---->
			<section id="services" data-label=""
				class="g_section g_services g_dark g_autoHeight" jsonkey="services"><!---->
			<div class="g_restrict">
				<div class="g_content">
					<div class="g_text">
...
h2, h3, p {
	word-break: keep-all !important;
		...
		<script type="text/javascript"
			src="https://www.nespresso.com/shared_res/agility/define/js/OriginalSystem.js"></script>
	</div>
