...
<link rel="stylesheet" type="text/css" href="/nespresso/resources/css/VertuoSystem.css" />
...
<!-- ------------------------------------------상단 끝---------------------------------------------------- -->
		...
		<main id="main">
			<span id="a11y-main-area" class="visually-hidden" tabindex="-1">메인
				컨텐츠를 보고 계십니다.</span>
			<div id="block-8810057586165" class="free-html" data-label="">
				<div class="g g_vertuolLine g_vertuoSystem">
					<div class="g_breadcrumb">
						<nav class="g_nav" style="">
							<div class="g_restrict">
								<div class="g_fil">
									<ol>
										<li><a href="./choose-your-system" class=""><span
												class="">선택하기</span></a></li>
										<li><a href="./vertuo-coffee-redefined" class=""><span
												class="">버츄오</span></a></li>
									</ol>
								</div>
								<div class="g_mobileMenu">
									<button class="g_btnMenu g_txt_S">
										<span class="">버츄오</span><i aria-hidden="true"
					...
					<section id="hero" data-label=""
						class="g_section g_hero g_light g_right g_mobileBottom"
						classnames="">
						<div class="g_bg g_imgSrc g_imgSrc_loaded"
							style="background-color: rgb(212, 205, 195); background-image: url(&quot;https://www.nespresso.com/shared_res/agility/define/vertuoSystem/img/backgrounds/vl_hero_machine_campaign_L.jpg&quot;);"></div>
						<div class="g_restrict">
							<div class="g_content">
								<div class="g_text">
									<!---->
									<h1 class="g_h1">
										NEW VERTUO<br> 회전 추출로 다른 차원의 커피가 탄생하다
									</h1>
									<!---->
									<div class="g_anchors">
										<ul class="g_row2">
    ...
    <path
												...
												<button class="g_anchor">
													<svg xmlns="http://www.w3.org/2000/svg" width="80px"
														height="80px" viewBox="0 0 80 80"
														class="injected-svg g_visual"
														data-src="/shared_res/agility/define/img/features/vl_icon_7.svg"
														aria-hidden="true">
    <path
															d="M40 0C17.9 0 0 17.9 0 40s17.9 40 40 40 40-17.9 40-40S62.1 0 40 0zm0 78.5C18.7 78.5 1.5 61.3 1.5 40S18.7 1.5 40 1.5 78.5 18.7 78.5 40 61.3 78.5 40 78.5zm22.2-29.1H59c0-5.2-.4-11.1-2.8-16.1-1.4-2.9-3.3-5.1-5.7-6.7-2.8-1.8-6.2-2.7-10.4-2.7-7.7 0-13.1 3.1-16.1 9.3-2.5 5.1-2.9 11.2-2.9 16.1h-3.4c-.4 0-.8.4-.8.8s.4.8.8.8h44.4c.4 0 .8-.4.8-.8.1-.3-.3-.7-.7-.7zm-10.1 0c0-10.6-2.1-16.6-2.1-16.7-.1-.2-.3-.4-.6-.3l-.6.2c-.2.1-.4.3-.3.6.1.2 2 6 2 16.2h-9.8V30c0-.4-.3-.7-.8-.7-.4 0-.8.3-.8.7v19.4h-9.8c0-10.3 2-16.1 2-16.2.1-.2 0-.5-.3-.6l-.6-.2h-.3c-.1.1-.2.1-.2.3-.1.2-2.1 6.1-2.1 16.6h-5.3c0-4.7.4-10.6 2.7-15.4 1.3-2.6 3-4.6 5.2-6 2.5-1.6 5.7-2.4 9.4-2.4 3.8 0 7 .8 9.5 2.4 2.2 1.4 3.9 3.4 5.1 6 2.2 4.7 2.6 10.4 2.6 15.4l-4.9.1z"></path>
</svg>
													<span class="">버츄오 커피</span>
												</button>
											</li>
											<!-- <li><button class="g_anchor">
													<svg xmlns="http://www.w3.org/2000/svg" width="80px"
    ...
    <path
					...
					<section id="choice" data-label=""
						...
						<div class="g_bg g_imgSrc g_imgSrc_loaded"
							style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/define/vertuoSystem/img/backgrounds/vl_crema_L.jpg&quot;);"></div>
						<div class="g_restrict">
							<div class="g_content">
								<div class="g_text">
									<h2 class="g_h2">회전 추출로 탄생한 풍성한 크레마와 깊은 바디감</h2>
									<h3 class="g_h3">네스프레소만의 혁신적인 회전 추출 센트리퓨전 (Centrifusion™)
									</h3>
									<div class="g_wysiwyg g_txt_M">
										<p>네스프레소가 최초로 선보이는 버츄오의 혁신적인 센트리퓨전 (Centrifusion™) 회전 추출로
											탄생한 풍성한 크레마와 깊은 바디감의 커피를 경험해보세요.</p>
										<p>최대 7,000RPM의 초고속 회전 추출로 지금까지 경험할 수 없었던 풍성한 크레마와 깊은 바디감을
											완성합니다.</p>
										<style>
@media screen and (min-width: 768px) {
	#choice .g_text {
		...
		padding: 0 0 0 1em !important;
									...
									<a href="./vertuo-coffee-machines-ranges" class="g_link"><span
										class="">버츄오 머신 자세히 보기 ></span>
					...
					<section id="crema" data-label=""
						class="g_section g_light g_right g_mobileBottom">
						<div class="g_bg g_imgSrc g_imgSrc_loaded"
							style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/define/vertuoSystem/img/backgrounds/vl_capsule_top_marble_L.jpg&quot;);"></div>
						<div class="g_restrict">
							<div class="g_content">
								<div class="g_text">
									<h2 class="g_h2">최적의 커피를 위한 원터치 바코드 테크놀로지</h2>
									<h3 class="g_h3">네스프레소 버츄오</h3>
									<div class="g_wysiwyg g_txt_M">
										<p>버튼 한 번만 누르면, 캡슐 고유의 바코드를 읽어 추출 시간과 속도, 온도까지 최적의 조건을
											자동으로 맞춰 당신이 원하는 완벽한 커피를 만들어줍니다.</p>
										<p>버츄오의 램프가 캡슐이 자동인식되고 있다는 것을 알려주며, 캡슐에 따라 추출 설정을 조정하면서
											추출이 시작됩니다.</p>
										<p>버튼 한 번으로 최적의 커피를 만드는 바코드 테크놀로지로 당신이 원하는 완벽한 커피를 만나보세요.</p>
										<style>
@media screen and (min-width: 768px) {
	#crema .g_text {
		margin: 0 !important;
		padding: 0 0 0 1em !important;
									...
									<a href="./vertuo-coffee-machines-ranges" class="g_link"><span
										class="">버츄오에 대해 알아보기 ></span>
										<!-- <i aria-hidden="true" class="fn_angleLink"></i> --></a>
								</div>
							</div>
						</div>
					</section>
					<section id="reverso" data-label=""
						class="g_section g_light g_left g_mobileBottom">
						<div class="g_bg g_imgSrc g_imgSrc_loaded"
							style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/define/vertuoSystem/img/backgrounds/vl_cups_L.jpg&quot;);"></div>
						<div class="g_restrict">
							<div class="g_content">
								<div class="g_text">
									<h2 class="g_h2">다양한 5가지 커피 스타일</h2>
									<div class="g_wysiwyg g_txt_XL">
										<p>당신의 취향에 맞춰 경험하는 최상의 커피</p>
									</div>
									<div class="g_wysiwyg g_txt_M">
										<p>에스프레소(40ml)에서 더블 에스프레소(80ml), 그랑 룽고 (150ml), 머그(230ml),
											알토(414ml)까지 당신의 취향에 맞춰 다양한 5가지 커피 스타일을 즐길 수 있습니다.</p>
										<p>버츄오는 새로운 회전 추출로 풍부한 크레마와 깊은 바디감의 커피를 머그 이상의 큰 컵으로 즐길 수
											있습니다. 5가지 커피 스타일과 28가지 종류의 커피로 당신의 취향에 맞춰 최상의 커피를 경험해보세요.</p>
										<br>
										<style>
@media screen and (min-width: 768px) {
	#reverso .g_text {
	...
	#reverso .g_bg {
		...
		transform: scaleX(-1) !important;
					...
					<section id="video" data-label=""
						class="g_section g_dark g_video g_center">
						<div class="g_bg g_imgSrc g_imgSrc_loaded"
							style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/define/vertuoSystem/img/backgrounds/vl_capsules_ground_L.jpg&quot;);"></div>
						<div class="g_restrict">
							<div class="g_content">
								<div class="g_text">
									<!---->
									<div class="g_wysiwyg g_txt_XL">
										<p>네스프레소 버츄오로 만나는 놀라운 커피의 세계를 지금 경험해보세요. 혁신적인
											센트리퓨전(Centrifusion™) 회전 추출로 탄생한 풍성한 크레마와 깊은 바디감의 커피를 5가지 커피
											스타일로 즐길 수 있습니다. 버튼 한 번으로 최적의 커피를 만드는 바코드 테크놀로지가 당신이 원하는 완벽한
											커피를 만들어줍니다.</p>
									</div>
									<button class="g_playVideo">
					...
					<!---->
					<section id="centrifusion" data-label=""
						class="g_section g_light g_left g_mobileBottom">
						<div class="g_bg g_imgSrc g_imgSrc_loaded"
							style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/define/vertuoSystem/img/backgrounds/vl_reverso_L.jpg&quot;);"></div>
						<div class="g_restrict">
							<div class="g_content">
								<div class="g_text">
									<h2 class="g_h2">밀크 커피로도 부드럽게 즐기는 버츄오</h2>
									<h3 class="g_h3">
										<p>버츄오 커피에 우유를 더하면 부드럽고 달콤한 아로마가 더욱 살아납니다. 에스프레소 혹은 더블
											에스프레소로 라테를 즐겨보세요.</p>
									</h3>
									<div class="g_wysiwyg g_txt_M">
										<p>잔에 우유를 먼저 붓고 커피를 추출하는 리버소(REVERSO)로도 부드러운 밀크 커피를 즐길 수
											있습니다.</p>
										<style>
#centrifusion .g_link {
	display: none;
					...
					<section id="faq" data-label=""
						...
						<div class="g_bg g_imgSrc g_imgSrc_loaded"
							style="background-image: url(&quot;https://www.nespresso.com/shared_res/agility/define/vertuoSystem/img/backgrounds/vl_machine_top_black_left_L.jpg&quot;);"></div>
						<div class="g_restrict">
							<div class="g_content">
								<div class="g_text">
									...
									<div class="g_accordion">
										...
										aria-hidden="true"></i>
														<span>버츄오와
														오리지널에는 어떤 차이가 있나요?</span>
												</button>
												<div class="g_wysiwyg" style="display: none;">
													<p>추출 방식이 다릅니다. 오리지널은 클래식한 고압 추출 방식으로 추출한 에스프레소에 물을
														추가하여 마일드한 아메리카노를 즐길 수 있으며, 총 28가지 종류가 있습니다. 버츄오는 새로운
														센트리퓨전(Centrifusion™) 회전 추출로 풍부한 크레마와 깊은 바디감의 커피를 큰 컵으로 즐길
														수 있습니다</p>
												</div>
											</li>
											<li class="g_accordionItem">
										...
										aria-hidden="true"></i>
														<span>버츄오는
														필터 커피나 인스턴트 커피 등 다른 커피들과 어떻게 다른가요?</span>
												</button>
												<div class="g_wysiwyg" style="display: none;">
													<p>버츄오가 다른 커피와 차별화된 점은 바로 추출에 있습니다. 센트리퓨전
														(Centrifusion™) 회전 추출로 풍성한 크레마와 깊은 바디감의 커피를 큰 컵으로 즐길 수
														있습니다. 또한 버튼 한번으로 사용자의 취향을 읽어 최적의 커피를 만드는 바코드 테크놀로지와 다양한
														5가지 커피 스타일로 당신이 원하는 최고의 커피 경험을 선사할 것입니다.</p>
												</div></li>
											<li class="g_accordionItem">
												<button style="margin: 0 0 .25em"
													data-translate="Accordion item" data-of="of" tabindex="0"
													id="19PNy_3_3" class="g_title">
										...
										aria-hidden="true"></i>
												...
												<div class="g_wysiwyg" style="display: none;">
													<p>모든 네스프레소 캡슐은 알루미늄으로 만들어지며, 재활용이 가능합니다. 사용한 캡슐을 가까운
														네스프레소 매장으로 가져가거나 재활용 봉투에 넣어 다음 커피 주문시 배송 기사분을 통해 보내주세요.
														네스프레소 커피를 즐기고 난 후 재활용에까지 동참하신다면 단순히 커피 맛을 즐길 뿐 아니라 기분까지
														좋아질 것입니다.</p>
												</div></li>
											<li class="g_accordionItem">
												<button style="margin: 0 0 .25em"
													data-translate="Accordion item" data-of="of" tabindex="0"
													id="19PNy_4_4" class="g_title">
										...
										aria-hidden="true"></i>
														<span>네스프레소
														캡슐의 카페인 함량은 얼마나 되나요?</span>
												</button>
												<div class="g_wysiwyg" style="display: none;">
													<p>네스프레소 커피마다 카페인 함량이 다르지만 일반적으로 오리지널 커피는 50-120mg의
														카페인을 함유하며 버츄오는 종류에 따라 60-200mg의 카페인을 함유하고 있습니다. 각 커피 고유의
														함량은 네스프레소 클럽을 통해 문의해주시기 바랍니다.</p>
												</div></li>
											<li class="g_accordionItem">
												<button style="margin: 0 0 .25em"
													data-translate="Accordion item" data-of="of" tabindex="0"
													id="19PNy_5_5" class="g_title">
										...
										aria-hidden="true"></i>
														<span>네스프레소가
														제안하는 아이스 커피 레시피는 무엇인가요?</span>
												</button>
												<div class="g_wysiwyg" style="display: none;">
													<p>네스프레소의 전문가들은 완벽한 맛의 조화, 풍부한 아로마를 선사하기 위해 정교하게 측정한
														레시피를 완성했습니다. 이 레시피로 블랙 커피와 밀크 커피를 쉽게 만들 수 있습니다. - 블랙: 얼음
														90g + 커피 40ml + 찬물 90ml - 밀크: 얼음 90g + 커피 40ml + 찬 우유거품
														90ml 정확한 분량을 지켜야 최상의 결과물을 낼 수 있습니다. 선호하는 에스프레소로 아이스 커피를
														만들어보세요.</p>
												</div></li>
											<li class="g_accordionItem">
												<button style="margin: 0 0 .25em"
													data-translate="Accordion item" data-of="of" tabindex="0"
													id="19PNy_6_6" class="g_title">
										...
										aria-hidden="true"></i>
												...
												<div class="g_wysiwyg" style="display: none;">
													네 우유와 환상적인 조화를 이룹니다.<br> 물론 어떤 커피를 원하느냐에 따라 조금씩 달라질 수
													있습니다. 예를 들어, 이스피라치오네 팔레르모 카자르와 이스피라치오네 나폴리와 같이 강도 높은 커피의
													경우에는 우유를 넣었을 때 진한 로스팅 특성이 유지되지만, 볼루토처럼 마일드한 커피는 우유의 영향을 더
													많이 받게 됩니다. 강렬한 커피는 레시피에 우유를 더해도 기분 좋은 스모키한 쓴 맛과 로스팅향을 유지하는
													반면에 마일드한 커피는 우유와 함께 마시면 캐러멜/비스킷향이 더욱 살아납니다. 달콤한 커피 경험을 위해
													여러 가지 레시피를 만들어 경험하다 보면 내가 원하는 나만의 커피를 찾아낼 수 있을 것입니다.
												</div></li>
											<li class="g_accordionItem">
												<button style="margin: 0 0 .25em"
													data-translate="Accordion item" data-of="of" tabindex="0"
													id="19PNy_7_7" class="g_title">
										...
										aria-hidden="true"></i>
												...
												<div class="g_wysiwyg" style="display: none;">
													<p>커피 체리는 커피 나무의 열매를 말합니다. 커피 원두는 커피 체리의 안에 들어 있으며 로스팅
														및 그라인딩을 통해 커피로 만들어지게 됩니다.</p>
												</div></li>
											<li class="g_accordionItem">
												<button style="margin: 0 0 .25em"
													data-translate="Accordion item" data-of="of" tabindex="0"
													id="19PNy_8_8" class="g_title">
										...
										aria-hidden="true"></i>
												...
												<div class="g_wysiwyg" style="display: none;">
													<p>커피는 다양한 방법으로 만들고 마실 수 있는 폭 넓은 활용도를 가지고 있습니다. 네스프레소는
														언제나 완벽한 커피 경험을 선사하는 머신과 커피를 제안합니다. 선택하는 블렌드에 따라 에스프레소와 같은
														매우 강렬한 이탈리안 커피, 더 양이 많고 부드러운 커피, 초콜릿 맛이 나는 커피 등 다양한 커피를
														폭넓게 선택하며 즐길 수 있습니다.</p>
												</div></li>
										</ul>
										<!---->
										<!---->
								...
								<div class="g_text">
									...
									<ul>
										<li><div
												...
												style="background-image: url(&quot;/shared_res/agility/commons/img/services/freeDelivery.svg&quot;);"></div>
											<h3 class="g_h4">
										...
										<li><div
												...
												style="background-image: url(&quot;/shared_res/agility/commons/img/services/assistance.svg&quot;);"></div>
											<h3 class="g_h4">머신 어시스턴스</h3>
											<p class="g_txt_M">
												머신에 관해 도움이 필요하신가요?<br> 네스프레소 전문가가 도와드리겠습니다.<br>
												네스프레소 클럽 (080-734-1111)<br> 24시간 365일, 수신자 부담<br>
												<style>
h2, h3, p {
	word-break: keep-all !important;
				...
				<script type="text/javascript"
					src="https://www.nespresso.com/shared_res/agility/define/js/VertuoSystem.js"></script>
			</div>
