			...
			<div data-label="Nespresso Recycling" id="hero"
				...
				<div class="g_recyclingHero__split">
					...
					<div class="g_split open" style="height: 100vh; z-index: 2000;">
						<div class="g_splitPane aluminium active"
							style="width: calc(100% - 0px);">
							<div class="g_splitPaneWrapper" style="width: 1343px;">
								...
								<div class="g_splitPaneDetails"
									...
									<div class="g_splitPaneDetails__title">
										...
										<h2 class="g_h2"
											style="opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);">알루미늄
											캡슐</h2>
									</div>
											...
											<div class="g_splitPaneSection__content">
												<div class="g_splitPaneSection__text">
													...
													<div class="g_wysiwyg g_txt_M">
														<p>알루미늄은 현존하는 가장 강력한 보호재로써 정성 들여 만든 아로마를 신선하게 유지하고 커피의
															풍부한 풍미를 보장합니다. 가볍지만 강한 알루미늄은 커피의 품질을 떨어뜨릴 수 있는 산소, 습도, 빛과
															같은 외부의 요소들로부터 커피를 완벽하게 보호합니다.</p>
													</div>
												</div>
													...
													<div class="g_media">
														<div class="g_media__cover">
															...
															<img class="g_media__image g_imgSrc g_imgSrc_loaded"
																src="https://www.nespresso.com/shared_res/agility/recycling2019/recycling2019/img/split/aluminium-section-1-ol_L.png">
														</div>
													</div>
													<!---->
												</div>
												...
												<div class="g_splitPaneSection__text">
													...
													<div class="g_wysiwyg g_txt_M">
														<p>네스프레소는 가능한 모든 곳에서 차이를 만들어 나가는 방법을 모색합니다. 그렇기 때문에,
															...
															필요가 있으니까요. 캡슐 재활용이 당신이 즐기는 네스프레소 커피 타임의 한 순서로 자리 잡을 때, 커피
															맛뿐 아니라 환경을 살리는 당신의 기분까지 좋아집니다.</p>
													</div>
												</div>
												<div class="g_splitPaneSection__cover">
													<div class="g_media">
														<div class="g_media__cover">
															<!---->
															<img class="g_media__image g_imgSrc g_imgSrc_loaded"
																src="https://www.nespresso.com/shared_res/agility/recycling2019/recycling2019/img/split/aluminium-section-2-ol_L.png">
														</div>
													</div>
													<!---->
												</div>
