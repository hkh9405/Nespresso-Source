...
<body>
	...
	<div id="block-8815991969269" class="free-html" data-label="">
		<div class="g g_recycling">
			<div data-label="Nespresso Recycling" id="hero"
				...
				style="background-image: url(&quot;/shared_res/agility/recycling2019/recycling2019/img/backgrounds/hero_L.jpg&quot;);">
				<div class="g_recyclingHero__split">
					<h2 class="g_h2">
						<strong class="v_brand" term="nespresso">Nespresso</strong>
						Recycling
					</h2>
					<div class="g_split open" style="height: 100vh; z-index: 2000;">
						<div class="g_splitPane ground active"
							style="width: calc(100% - 0px);">
							<div class="g_splitPaneWrapper">
								<div class="g_splitPaneCover" style="z-index: 0; opacity: 0;">
									<img class="g_splitPaneCover__figure g_imgSrc g_imgSrc_loaded"
										src="/shared_res/agility/recycling2019/recycling2019/img/split/ground-ol_L.png"
										style="opacity: 0; transform: matrix(1, 0, 0, 1, -50, 0);">
									<div class="g_splitPaneCover__caption"
										style="opacity: 0; transform: matrix(1, 0, 0, 1, -100, 0);">
										<h3 class="g_h3">커피 가루</h3>
										<button class="g_link">
											<span class="">자세히 보기</span><i class="fn_angleLink"></i>
										</button>
									</div>
								</div>
								<div class="g_splitPaneDetails"
									style="z-index: 1; opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);">
									<div class="g_splitPaneDetails__title">
										<button class="g_btnRoundS g_btnClose" onclick="location.href='http://localhost:8080/nespresso/recycleservice.action';"
											style="opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);">
											<i class="fas fa-times"></i><!-- <i class="fn_close"></i> -->
										</button>
										<h2 class="g_h2"
											style="opacity: 1; transform: matrix(1, 0, 0, 1, 0, 0);">커피
											가루</h2>
									</div>
											...
											<div class="g_splitPaneSection__content">
												<div class="g_splitPaneSection__text">
													...
													<div class="g_wysiwyg g_txt_M">
														<p>알루미늄에서 분리된 커피 가루는 점점 더 혁신적인 방식으로 재사용되고 있습니다. 추출 후,
															커피 가루가 퇴비로 사용되기도 하고, 버스를 위한 바이오 연료와 같은 재생 에너지로도 사용되고
															있습니다.</p>
													</div>
												</div>
														...
														<div class="g_media__cover">
															<h3 class="g_media__action g_h3">
																...
																<svg xmlns="http://www.w3.org/2000/svg" width="18"
																	...
																	aria-hidden="true"> <path fill="#FFFFFF"
															...
															<img class="g_media__image g_imgSrc g_imgSrc_loaded"
																src="https://www.nespresso.com/shared_res/agility/recycling2019/recycling2019/img/split/ground-section-1_L.png">
														</div>
													</div>
													<!---->
												</div>
	...
	<link
		href="https://www.nespresso.com/shared_res/agility/recycling2019/css/app.css"
		rel="stylesheet">
